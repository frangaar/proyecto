                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-4">
                    <div class="col developers-fondo">
                        <div class="card mb-3 h-100">
                            <div class="row g-0">
                                ...
                                <img src="img/desarrolladores/david-foto.jpg" class="img-fluid developers-img" alt="...">
                                </div>
                    ...
                    <div class="col developers-fondo">
                        <div class="card mb-3 h-100">
                            <div class="row g-0">
                                <div class="col-1 col-sm-2 col-md-4 mt-2 developer-img-container">
                                <img src="img/desarrolladores/jiajie.jpg" class="img-fluid developers-img" alt="...">
                                </div>
                                <div class="col col-md-8">
                                <div class="card-body">
